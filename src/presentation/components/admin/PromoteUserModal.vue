...
<template>
  ...
  >
    <div data-testid="promote-user-modal" class="space-y-4">
      ...
      <!-- Results table -->
      <div v-else-if="filteredUsers.length > 0" class="overflow-x-auto rounded-md border border-gray-200 dark:border-gray-700">
          ...
          <tbody class="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-800">
            ...
            >
              <td class="px-3 py-3 text-sm font-medium text-gray-900 dark:text-gray-100">
                ...
                <div class="text-xs text-gray-400 sm:hidden truncate max-w-[130px]">{{ user.email }}</div>
              </td>
              <td class="px-3 py-3 text-sm text-gray-500 dark:text-gray-400 truncate hidden sm:table-cell">
                {{ user.email }}
              </td>
