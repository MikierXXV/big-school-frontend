/**
 * ============================================
 * TEST: SurgicalBlockView Component
 * ============================================
 */
...
import SurgicalBlockView from '@presentation/views/dashboard/SurgicalBlockView.vue';
...
describe('SurgicalBlockView', () => {
  ...
  describe('Rendering', () => {
    it('should render within DashboardLayout', async () => {
      ...
      await router.push('/surgical-block');

      const wrapper = mount(SurgicalBlockView, {
